...
async function loadSharedHeader() {
  ...
  try {
    const response = await fetch(`common_page/header.html?v=${ASSET_VERSION}`);
...
async function loadSharedFooter() {
  ...
  try {
    const response = await fetch(`common_page/footer.html?v=${ASSET_VERSION}`);
...
async function loadThanksMessages() {
  try {
    const response = await fetch(`data/thanks-data.json?v=${ASSET_VERSION}`);
...
async function loadAlbumDay() {
  ...
  try {
    const response = await fetch(`data/albums-data.json?v=${ASSET_VERSION}`);
